...
<body>
    ...
    <div id="permission-phone" class="d-none"><?=$_SESSION['phone']?></div>
    <div id="permission" class="d-none">user</div>
                                    ...
                                    <div id="section-wrap">
                                        <div id="balance-info">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="wallet-balance me-3"></div>
                                            </div>
                        ...
                        <div class="col-12">
                            <div id="account-container">
                                ...
                                <button class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#change-password-modal">Change Password
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="info-group transfer-info">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div id="receiver-name" class="form-control"></div>
                                        </div>
    ...
    <div id="history-modal" class="modal fade" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content bg-dark">
                <div class="modal-header flex-column">
                    <button id="close-pass-form" type="button" class="btn-close bg-danger" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                    <h4 class="modal-title mx-auto">History detail</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <label>Transaction id:</label>
                            <div id="history-idtrans" class="history-info"></div>
                        </div>
                        <div class="col">
                            <label>Transaction type:</label>
                            <div id="history-transtype" class="history-info"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label>Transaction Date:</label>
                            <div id="history-date" class="history-info"></div>
                        </div>
                        <div class="col">
                            <label>Amount:</label>
                            <div id="history-amount" class="history-info"></div>
                        </div>
                    </div>
                    <div id="card-wrap" class="row">
                        <div class="col">
                            <label>Network Name:</label>
                            <div id="history-network"></div>
                        </div>
                        <div class="col">
                            <label>Price Each Card:</label>
                            <div id="history-price"></div>
                        </div>
                        <div class="col">
                            <label>Quantity:</label>
                            <div id="history-quantity"></div>
                        </div>
                        <div class="d-flex justify-content-center my-4">
                            <button class="btn btn-outline-primary" data-bs-toggle="collapse" data-bs-target="#card-num"
                                aria-expanded="false" aria-controls="card-num">Show Card Number</button>
                        </div>
                    </div>
                    <div id="receiver-wrap" class="row">
                        <div class="col">
                            <label>Receiver:</label>
                            <div id="history-receiver"></div>
                        </div>
                    </div>
                    <div id="note-wrap" class="row">
                        <div class="col">
                            <label>Note:</label>
                            <div id="history-note"></div>
                        </div>
                    </div>
                    <div class="collapse" id="card-num">
                        <div class="card card-body d-flex flex-column align-items-center"></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div id="otp-modal" class="modal fade" data-bs-backdrop="static" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-dark">
                <div class="modal-header flex-column">
                    <button id="close-otp-form" type="button" class="btn-close bg-danger" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                    <h4 class="modal-title mx-auto">Verify OTP</h4>
                </div>
                <div class="modal-body d-flex flex-column align-items-center">
                    ...
                    <div class="form-group my-4">
                        ...
                        <small id="otp-mess" class="text-danger"></small>
                    </div>
                    <div>
                        Code will be expired in <span id="otp-countdown"></span>
                    </div>
                </div>
                <div class="modal-footer justify-content-center">
                    <button id="verify-btn" type="button" class="btn btn-outline-primary">Verify</button>
                </div>
            </div>
        </div>
    </div>
